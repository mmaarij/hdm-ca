...
/**
 * Legacy DocumentVersion factory functions
 * @deprecated Use DocumentVersionEntity.create() or constructor instead
 */
export const DocumentVersion = {
  ...
  create: (props: {
    ...
    return new DocumentVersionEntity(
      ...
      props.mimeType,
      props.size,
      normalizeMaybe(props.path),
      normalizeMaybe(props.contentRef),
      normalizeMaybe(props.checksum),
      props.versionNumber,
      props.uploadedBy,
      new Date()
    );
  ...
  ): DocumentVersionEntity => version.updateAfterUpload(updates),
};

/**
 * Legacy Document factory functions
 * @deprecated Use DocumentEntity.create() or methods instead
 */
export const Document = {
  ...
  ): DocumentEntity => document.addVersion(versionProps),
  ...
  ): DocumentEntity => document.update(updates),
  ...
  getLatestVersion: (
    document: DocumentEntity
  ): Option.Option<DocumentVersionEntity> => document.getLatestVersion(),
  ...
  getVersion: (
    document: DocumentEntity,
    versionNumber: VersionNumber
  ): Option.Option<DocumentVersionEntity> => document.getVersion(versionNumber),
  ...
  getAllVersions: (
    document: DocumentEntity
  ): readonly DocumentVersionEntity[] => document.getAllVersions(),
  ...
  hasVersion: (
    document: DocumentEntity,
    versionNumber: VersionNumber
  ): boolean => document.hasVersion(versionNumber),
};
